...
function App() {
  return (
    ...
    <div className="App container">
      ...
      <input type="text" placeholder="Username" name="username" value="<?php echo $username; ?>"></input>
      <input type="email" placeholder="Email" name="email" value="<?php echo $email; ?>"></input>
