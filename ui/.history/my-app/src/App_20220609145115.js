...
function App() {
  return (
    ...
    <div className="App container">
      ...
      <input type="password" placeholder="Password" name="password_1"   title=" Six or more characters"></input>
      <input type="password" placeholder="Repeat Password" name="password_2" ></input>
