...
export class Lenda extends Component{
    ...
    Filterfn(){
        ...
        var filteredData=this.state.lendetWithoutFilter.filter(
            function(el){
                return el.LendaId.toString().toLowerCase().includes(
                    LendaIdFilter.toString().trim().toLowerCase()
                )&&
                el.LendaName.toString().toLowerCase().includes(
                    LendaNameFilter.toString().trim().toLowerCase()
                )
            }
        );
