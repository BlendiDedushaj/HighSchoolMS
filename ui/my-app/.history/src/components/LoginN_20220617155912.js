...
function Login() {
  ...
  const renderForm = (
    <div>
    <img src="https://www.pikpng.com/pngl/m/515-5152656_custom-icons-marc-engle-transparent-background-students-clipart.png" alt="Girl in a jacket" width="400" height="250"></img>
    <div className="form">
