...
function Login() {
  ...
  const renderForm = (
    <div>
    <img src="https://cdn5.vectorstock.com/i/1000x1000/23/49/outline-parents-icon-isolated-black-simple-line-vector-28252349.jpg" alt="Girl in a jacket" width="400" height="250"></img>
